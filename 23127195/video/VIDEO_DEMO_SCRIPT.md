...
**Yêu cầu:** Tự thuyết minh tiếng Việt, quay trực tiếp màn hình thực thi Postman, Newman CLI và header `X-Student-Id: 23127195`.
...
- Mở Pre-request script minh chứng tự động gắn header `X-Student-Id: 23127195`.
