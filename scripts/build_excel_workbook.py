...
def _write_bugs(wb: Workbook) -> None:
    ...
    bugs = [
        ("BUG-FR02-001", "FR02", "P1", "Plaintext password disclosed in login response JSON",
         "https://github.com/thangak18/HW06/issues/1",
         "23127259/bugs/FR02_BUG_CANDIDATES.md; FR02 Run03 (FR02-AI-028)",
         "CONFIRMED"),
        ("BUG-FR02-002", "FR02", "P2", "Account remains locked beyond documented 30-second lockout duration",
         "https://github.com/thangak18/HW06/issues/2",
         "23127259/bugs/FR02_BUG_CANDIDATES.md; FR02 Run03 (FR02-AI-021)",
         "CONFIRMED"),
        ("BUG-FR02-003", "FR02", "P2", "Premature account lockout on valid login at N=2 boundary",
         "https://github.com/thangak18/HW06/issues/3",
         "23127259/bugs/FR02_BUG_CANDIDATES.md; FR02 Run03 (FR02-HUM-003)",
         "CONFIRMED"),
        ("BUG-FR10-001", "FR10", "P1", "Owner can cancel a confirmed order after it enters shipping",
         "https://github.com/thangak18/HW06/issues/29",
         "23127259/bugs/BUG-FR10-001.md; FR10 Run04",
         "CONFIRMED"),
        ("BUG-FR10-002", "FR10", "P1", "Canceled terminal order can be transitioned to delivered",
         "https://github.com/thangak18/HW06/issues/30",
         "23127259/bugs/BUG-FR10-002.md; FR10 Run04",
         "CONFIRMED"),
        ("BUG-FR10-003", "FR10", "P2", "Regular customer can mutate order status through Admin API",
        ...
        ("BUG-FR14-001", "FR14", "P1", "Non-admin (customer) role can mutate Categories",
         ...
         "23127259/bugs/BUG-FR14-001.md; FR14 Run01 (TC-FR14-012..014)",
         "CONFIRMED"),
        ("BUG-FR14-002", "FR14", "P2", "Category name validation accepts empty/null/whitespace",
         "https://github.com/thangak18/HW06/issues/33",
         "23127259/bugs/BUG-FR14-002.md; FR14 Run01 (TC-FR14-016..019)",
         "CONFIRMED"),
        ("BUG-FR14-003", "FR14", "P2", "Non-existent / already-deleted category update/delete returns false success",
         "https://github.com/thangak18/HW06/issues/34",
         "23127259/bugs/BUG-FR14-003.md; FR14 Run01 (TC-FR14-024/025/037/038)",
         "CONFIRMED"),
        ("BUG-FR14-004", "FR14", "P2", "Empty PUT body corrupts existing category name to null",
         "https://github.com/thangak18/HW06/issues/36",
