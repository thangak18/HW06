...
|---|---|---|---|
| **A** | TODO (e.g., FR-05) | TODO (e.g., Product search) | `GET /api/products` |
| **B** | TODO (e.g., FR-09) | TODO (e.g., Discount coupons) | `POST /api/coupons/apply` |
| **C** | TODO (e.g., FR-18) | TODO (e.g., Admin order management) | `PUT /api/admin/orders/:id/status` |
