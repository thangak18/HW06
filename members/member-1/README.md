...
|---|---|---|---|
| **A** | TODO (e.g., FR-02) | TODO (e.g., Login and lockout) | `POST /api/auth/login` |
| **B** | TODO (e.g., FR-07) | TODO (e.g., Shopping cart) | `POST /api/cart/items` |
| **C** | TODO (e.g., FR-15) | TODO (e.g., Product CRUD) | `POST /api/admin/products` |
