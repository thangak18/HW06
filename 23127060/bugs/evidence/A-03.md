# Bang chung tai hien bug A-03

**User enumeration: email khong ton tai tra 404, email ton tai tra 200**
...
{"message":"User registered successfully","id":22}
```
...
{"message":"Mã đặt lại mật khẩu đã được tạo","resetToken":"9802"}
```
