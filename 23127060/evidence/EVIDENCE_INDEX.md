...
|---|---|---|---|
| **Header Verification** | `X-Student-Id: 23127060` in console screenshot | `evidence/header_verification.png` | TODO |
...
- **`header_verification.png`**: Postman Console showing `X-Student-Id: 23127060` attached to outbound requests.
